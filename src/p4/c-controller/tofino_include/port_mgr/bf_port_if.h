...
typedef enum {
  ...
  // Consortium iExtended Tech Ability Field options
  BF_ADV_SPD_25GBASE_KR1_CONSORTIUM = (1 << 11),
  BF_ADV_SPD_25GBASE_CR1_CONSORTIUM = (1 << 12),
  BF_ADV_SPD_50GBASE_KR2_CONSORTIUM = (1 << 13),
  BF_ADV_SPD_50GBASE_CR2_CONSORTIUM = (1 << 14),
} bf_an_adv_speeds_t;
...
bf_status_t bf_port_1588_timestamp_tx_get(bf_dev_id_t dev_id,
                                          ...
                                          bool *ts_valid,
                                          int *ts_id);
bf_status_t bf_port_1588_timestamp_rx_get(bf_dev_id_t dev_id,
                                          bf_dev_port_t port,
                                          uint64_t *ts,
                                          bool *ts_valid,
                                          int *ts_id);
